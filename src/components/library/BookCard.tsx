        ...
        <div className="w-28 h-40 flex-shrink-0 rounded-lg overflow-hidden relative shadow-md z-10">
          ...
          <div className="absolute inset-0 bg-background/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            <motion.button
              ...
              className="w-10 h-10 rounded-full bg-primary text-on-primary flex items-center justify-center shadow-lg focus:outline-none focus:ring-2 focus:ring-primary/40"
            >
        ...
        <div className="flex flex-col justify-between flex-1 z-10">
          ...
          <div className="flex items-center justify-between pt-4 mt-2 border-t border-outline-variant/10">
            ...
            <motion.button
              ...
              className="text-[10px] tracking-[0.15em] text-primary border border-primary/30 px-5 py-2 hover:bg-primary/10 transition-all uppercase font-semibold rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/40"
            >
              BORROW
            </motion.button>
          </div>
        ...
        <div className="aspect-[2/3] rounded-lg overflow-hidden mb-6 shadow-xl relative group bg-surface-container-lowest">
          ...
          <div className="absolute inset-0 bg-background/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              aria-label={`Quick view ${book.title}`}
              className="w-12 h-12 rounded-full bg-primary text-on-primary flex items-center justify-center shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 focus:outline-none focus:ring-2 focus:ring-primary/40"
            >
        ...
        <div className="space-y-2 flex-grow flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between pt-3 mt-3 border-t border-outline-variant/10">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              aria-label={`Borrow ${book.title}`}
              className="text-[10px] tracking-[0.15em] text-primary border-b border-primary/20 pb-0.5 hover:border-primary transition-all uppercase font-semibold focus:outline-none"
            >
              BORROW
            </motion.button>
          </div>
