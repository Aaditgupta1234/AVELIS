...
export type BookCardVariant = "featured" | "featuredLarge" | "editor";

export interface SharedBookProps {
  image: string;
  title: string;
  author: string;
  variant?: BookCardVariant;
  // Editors Picks specifics
  category?: string;
  description?: string;
  readingTime?: string;
  // Featured specifics
...
export const BookCard = ({
  ...
  return (
    <motion.div
      ...
      className={`group ${isLarge ? "lg:col-span-2" : ""} ${isEditor ? "flex flex-col h-full" : ""}`}
      whileHover="hover"
      initial="rest"
      animate="rest"
    >
