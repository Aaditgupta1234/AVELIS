  ...
  ({ className, variant = "primary", size = "md", children, ...props }, ref) => {
    return (
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className={cn(
          "inline-flex items-center justify-center font-inter font-medium transition-colors rounded focus:outline-none focus:ring-2 focus:ring-gold-primary focus:ring-offset-2 focus:ring-offset-bg-primary",
          {
