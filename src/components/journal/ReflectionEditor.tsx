...
export const ReflectionEditor = ({ onSave }: ReflectionEditorProps) => {
  ...
  return (
    <section className="mb-24 max-w-4xl mx-auto px-gutter">
      <form 
        onSubmit={handleSubmit}
        className="glass-card p-8 md:p-12 rounded-2xl shadow-2xl relative border border-outline-variant/10"
      >
        {/* Metadata Inputs */}
          ...
          <div className="flex-grow">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-transparent border-b border-outline-variant/20 py-3 pl-8 text-on-surface focus:border-primary focus:ring-0 transition-all outline-none font-body text-sm placeholder:text-on-surface-variant/30 caret-primary"
