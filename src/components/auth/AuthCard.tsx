...
export const AuthCard: React.FC<AuthCardProps> = ({ children, className }) => {
  return (
    <motion.div
      ...
      className={cn(
        "w-full max-w-[440px] bg-[#0D1626] border border-[rgba(201,162,39,0.18)] rounded-lg p-8 sm:p-10 relative overflow-hidden",
        "shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_40px_rgba(201,162,39,0.03)]",
        className
      )}
    >
