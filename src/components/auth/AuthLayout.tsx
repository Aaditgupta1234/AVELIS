...
export const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen bg-[#07111F] text-[#F7F5EE] flex flex-col lg:flex-row relative overflow-hidden">
      {/* Paper grain overlay */}
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-between p-8 sm:p-12 lg:p-20 relative z-10 border-b lg:border-b-0 lg:border-r border-[rgba(201,162,39,0.08)]">
        ...
        <div className="flex justify-between items-center w-full">
          ...
          <Link 
            to="/" 
            className="flex items-center gap-2 font-display text-[10px] tracking-[0.2em] text-[#F7F5EE]/60 hover:text-[#C9A227] uppercase transition-colors"
          >
        ...
        <motion.div 
          ...
          className="my-16 lg:my-0 space-y-6 max-w-lg"
        >
