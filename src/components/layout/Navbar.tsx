        ...
        <div className="max-w-container-max mx-auto px-gutter flex justify-between items-center">
          ...
          <div className="flex items-center gap-8">
            <motion.button
              ...
              transition={springs.smooth}
              className="material-symbols-outlined text-white/80 scale-90 focus:outline-none focus:ring-2 focus:ring-primary/50 rounded-full cursor-pointer"
            >
              search
            </motion.button>
                ...
                >
                  ...
                  >
                    <img
                      src={user?.avatar}
                      alt={user?.name}
                      className="w-8 h-8 rounded-full border border-primary/30 group-hover:border-primary transition-colors"
                    />
