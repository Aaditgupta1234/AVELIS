...
export const InteractiveRobot = () => {
    ...
    const handleSplineLoad = (splineApp) => {
        ...
        const scene = splineApp?._scene || splineApp?.scene || null;
        if (scene) {
            restyleScene(scene);
        }
        setIsLoaded(true);
    ...
    return (<div className="relative w-full h-full min-h-[360px] md:min-h-[520px] lg:min-h-[620px] flex items-center justify-center py-2">
