...
export const LibraryPage = () => {
    ...
    return (<div className="min-h-screen bg-[#07111F] text-on-background relative flex flex-col">
      ...
      <main className="pt-32 pb-24 relative z-10 flex-grow">
        {/* Hero Section */}
        <motion.section initial="hidden" animate="visible" variants={revealVariants.A} className="relative px-margin-mobile md:px-gutter max-w-container-max mx-auto py-16 text-center">
