export const ReaderExperience = () => {
    return (<section id="reader-experience" className="py-section-padding px-gutter overflow-hidden relative z-10">
        ...
        <div className="space-y-12 order-1 lg:order-2">
          ...
          <div className="space-y-10">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="font-display text-xl mb-2">Digital Paper™ Experience</h3>
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="font-display text-xl mb-2">Gilded Annotations</h3>
                <p className="text-on-background/60 font-light leading-relaxed">
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="font-display text-xl mb-2">Omni-Synchronicity</h3>
                <p className="text-on-background/60 font-light leading-relaxed">
