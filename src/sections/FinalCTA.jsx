...
export const FinalCTA = () => {
    ...
    return (<AnimatedSection variant="A" className="py-40 relative overflow-hidden text-center px-gutter z-10">
      ...
      {!shouldReduceMotion && (<motion.div animate={{
                ...
                repeat: Infinity,
                ease: "linear",
            }} className="absolute inset-0 z-0 pointer-events-none opacity-20" style={{
      ...
      <div className="max-w-4xl mx-auto space-y-12 relative z-10">
        ...
        }} whileTap={{ scale: 0.98 }} transition={{ ...springs.buttonClick, y: springs.smooth }} className="bg-primary text-on-primary px-16 py-8 font-display text-[14px] tracking-[0.3em] uppercase transition-colors cursor-pointer">
            Join the Collective
          </motion.button>
        </Link>
      </div>
