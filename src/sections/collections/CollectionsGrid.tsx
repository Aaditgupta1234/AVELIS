...
export const CollectionsGrid = ({ 
  ...
  return (
    <AnimatedSection variant="A" className="px-gutter max-w-container-max mx-auto mb-32 min-h-[500px]">
          ...
          {collections.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                initial="rest"
                animate="rest"
                className="group relative overflow-hidden border border-white/10 glass-panel h-[500px] flex flex-col transition-colors duration-700 hover:border-primary/50 bg-surface/50"
              >
                <motion.div
                  variants={{
