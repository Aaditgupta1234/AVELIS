...
export const CollectionsCTA = () => {
  return (
    <AnimatedSection variant="B" className="py-section-padding px-gutter max-w-container-max mx-auto text-center relative z-10 mb-20">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <motion.button
              ...
              className="bg-primary text-on-primary px-10 py-4 font-display text-[10px] tracking-[0.2em] uppercase transition-colors"
            >
              Explore Books
            </motion.button>
            <motion.button
              ...
              className="border border-primary text-primary px-10 py-4 font-display text-[10px] tracking-[0.2em] uppercase transition-colors"
            >
              Start Reading
            </motion.button>
          </div>
