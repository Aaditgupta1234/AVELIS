...
export const ReadingQuote = () => {
  return (
    <AnimatedSection variant="A" className="py-section-padding bg-surface-variant/20 relative border-t border-white/5">
      <div className="px-gutter max-w-3xl mx-auto text-center relative z-10">
        <span 
          className="material-symbols-outlined text-primary mb-8 text-4xl" 
