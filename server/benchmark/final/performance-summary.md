...
> **Run ID**: `2026-07-16T09-23-08-578Z` | **Generated**: 2026-07-16T09:58:56.212Z
...
| **Critical Issues** | 6 |
| **Historical Baseline Status** | ✓ Baseline compared |
...
_No metric improvements detected relative to historical baseline._

### Performance Regressions
_No metric regressions detected relative to historical baseline._

### Stable Metrics
| Metric | Current | Baseline | Delta |
| --- | --- | --- | --- |
| API analytics-borrowing Avg Latency | `16.68` | `16.68` | `0.00%` |
| API analytics-members Avg Latency | `4.12` | `4.12` | `0.00%` |
| API analytics-ratings Avg Latency | `6.26` | `6.26` | `0.00%` |
| API analytics-timeseries Avg Latency | `4.17` | `4.17` | `0.00%` |
| API auth-login Avg Latency | `80.38` | `80.38` | `0.00%` |
| API auth-register Avg Latency | `97.35` | `97.35` | `0.00%` |
| API books-get Avg Latency | `7.38` | `7.38` | `0.00%` |
| API books-list Avg Latency | `9.28` | `9.28` | `0.00%` |
| API books-rating Avg Latency | `10.80` | `10.80` | `0.00%` |
| API books-search Avg Latency | `11.53` | `11.53` | `0.00%` |
| API dashboard-analytics Avg Latency | `1.34` | `1.34` | `0.00%` |
| API dashboard-summary Avg Latency | `7.89` | `7.89` | `0.00%` |
| API loans-active Avg Latency | `6.43` | `6.43` | `0.00%` |
| API loans-borrow Avg Latency | `15.81` | `15.81` | `0.00%` |
| API loans-get-by-id Avg Latency | `6.13` | `6.13` | `0.00%` |
| API loans-history Avg Latency | `7.68` | `7.68` | `0.00%` |
| API loans-list Avg Latency | `9.65` | `9.65` | `0.00%` |
| API loans-renew Avg Latency | `15.35` | `15.35` | `0.00%` |
| API loans-return Avg Latency | `13.33` | `13.33` | `0.00%` |
| API reports-inventory Avg Latency | `6.12` | `6.12` | `0.00%` |
| API reports-member Avg Latency | `11.11` | `11.11` | `0.00%` |
| API reports-overdue Avg Latency | `3.57` | `3.57` | `0.00%` |
| API reports-search-books Avg Latency | `4.38` | `4.38` | `0.00%` |
| API reservations-cancel Avg Latency | `11.41` | `11.41` | `0.00%` |
| API reservations-create Avg Latency | `18.55` | `18.55` | `0.00%` |
| API reservations-get Avg Latency | `3.36` | `3.36` | `0.00%` |
| API reservations-list Avg Latency | `6.75` | `6.75` | `0.00%` |
| API reservations-mine Avg Latency | `5.75` | `5.75` | `0.00%` |
| API reviews-book Avg Latency | `6.89` | `6.89` | `0.00%` |
| API reviews-create Avg Latency | `8.88` | `8.88` | `0.00%` |
| API reviews-get Avg Latency | `6.17` | `6.17` | `0.00%` |
| API reviews-mine Avg Latency | `8.01` | `8.01` | `0.00%` |
| API reviews-rating Avg Latency | `8.16` | `8.16` | `0.00%` |
| API smoke Avg Latency | `0.02` | `0.02` | `0.00%` |
| API verify-report-test Avg Latency | `5.00` | `5.00` | `0.00%` |
| Prisma Query User Lookup Avg Latency | `1.00` | `1.00` | `0.00%` |
| Prisma Query Book Listing Avg Latency | `2.05` | `2.05` | `0.00%` |
| Prisma Query Book Search Avg Latency | `1.58` | `1.58` | `0.00%` |
| Prisma Query Loan Queries Avg Latency | `2.45` | `2.45` | `0.00%` |
| Prisma Query Reservation Queries Avg Latency | `1.68` | `1.68` | `0.00%` |
| Prisma Query Dashboard Aggregation Avg Latency | `1.97` | `1.97` | `0.00%` |
| Prisma Query Analytics Aggregation Avg Latency | `1.15` | `1.15` | `0.00%` |
| Prisma Query Reporting Queries Avg Latency | `4.50` | `4.50` | `0.00%` |
| Load Scen 50 Users RPS | `129.03` | `129.03` | `0.00%` |
| Load Scen 50 Users Avg Latency | `421.11` | `421.11` | `0.00%` |
| Load Scen 100 Users RPS | `105.07` | `105.07` | `0.00%` |
| Load Scen 100 Users Avg Latency | `991.36` | `991.36` | `0.00%` |
| Load Scen 250 Users RPS | `123.81` | `123.81` | `0.00%` |
| Load Scen 250 Users Avg Latency | `1334.67` | `1334.67` | `0.00%` |
| Load Scen 500 Users RPS | `210.58` | `210.58` | `0.00%` |
| Load Scen 500 Users Avg Latency | `1717.25` | `1717.25` | `0.00%` |
| Soak Test Latency Drift Ms | `-20.24` | `-20.24` | `0.00%` |
